...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:encodingDesc">
        <xsl:copy>
            <tei:editorialDecl>
                <tei:p>This text is the K'iche' column of the Ximenez edition of the Popol Wuj. Because of nature of CTS's unique identifiers
                    us to separate it from the Castellano column, which is stored as another "edition" of the text according to CTS structure.</tei:p>
            </tei:editorialDecl>
    ...
    <!-- Added to prevent output of K'iche' column -->
